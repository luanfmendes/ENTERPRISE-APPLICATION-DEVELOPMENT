...
public class LocacaoDAOImpl extends GenericDAOImpl<Locacao, LocacaoPK>
	...
	public List<Locacao> buscarPorData(Calendar inicio, Calendar fim) {
		return em.createQuery("from Locacao l where l.data "
				+ "between :i and :f",Locacao.class)
	...
	public long contarPorCliente(int codigoCliente) {
		return em.createQuery("select count(l) from Locacao l where "
				+ "l.cliente.codigo = :c",Long.class)
